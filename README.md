...
Fintech _peer-to-peer_ (P2P) lending akrab disebut _pindar_ (pinjaman daring), jadi tulang punggung pembiayaan bagi UMKM dan masyarakat _underbanked_ di Indonesia. Tapi pertumbuhan yang agresif punya sisi gelap: semakin cepat penyaluran kredit, semakin besar tekanan pada kualitas portofolio apalagi di tengah gejolak inflasi yang menggerus daya beli.
...
> ⚠️ **keterbatasan:** hasil ini dihitung dari **n = 7 bulan** saja karena OJK tidak konsisten merilis angka presisi tiap bulan di sumber publik. Korelasi kuat, tapi sampel kecil ini menjadi sinyal yang layak ditindaklanjuti, bukan bukti kausal final. Detail lengkap ada di bagian [Limitasi](#-limitasi--pengembangan-lanjutan).
...
- **Credit scoring** — masukkan variabel makro (inflasi, harga pangan/energi) sebagai _early warning indicator_
...
- **Regulasi** — dukung pembatasan rasio utang terhadap pendapatan untuk cegah _over-leverage_
